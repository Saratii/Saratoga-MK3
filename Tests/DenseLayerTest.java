...
public class DenseLayerTest {
    ...
    public void backward(){
        ...
        double[] actualWeights = Stream.of(dense.weights.matrix[0]).mapToDouble(Double::doubleValue).toArray();
        assertArrayEquals(expectedWeights, actualWeights, 0.000001);
        double[] actualBiases = Stream.of(dense.biases.matrix[0]).mapToDouble(Double::doubleValue).toArray();
    ...
    public void torchForward(){
        ...
        double[] actualDense1 = Stream.of(out1.matrix[0]).mapToDouble(Double::doubleValue).toArray();
        assertArrayEquals(expectedDense1, actualDense1, 0.001);
        ReLU relu1 = new ReLU();
        Matrix out2 = relu1.forward(out1);
        double[] actualRelu1 = Stream.of(out2.matrix[0]).mapToDouble(Double::doubleValue).toArray();
