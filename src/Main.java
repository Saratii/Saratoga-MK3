...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Model model = new Model(); //1, 625, 625
        model.layers.add(new ConvolutionLayer(10, 1, 3)); //10, 623, 623
        model.layers.add(new ReLU()); //10, 623, 623
        model.layers.add(new MaxPool(6)); //10, 104, 104
        model.layers.add(new ConvolutionLayer(10, 1, 3)); //100, 102, 102
        model.layers.add(new ReLU()); //100, 102, 102
        model.layers.add(new MaxPool(6)); //100, 17, 17
        model.layers.add(new Flatten()); //1, 28900, 1
