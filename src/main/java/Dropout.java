...
//
//    @Override
//    public Matrix forward(Matrix values, int threadIndex, int batchIndexForThread) {
//        if(isClassifying){
//            return values;
//        }
...
//                dropOuts[threadIndex].matrix[j][i] = Main.randoms[batchIndexForThread].nextDouble() > percentageLost ? scale : 0.0;
